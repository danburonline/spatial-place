...
UNFILTERED: This means that no filtering has been done on the data, if filtering has been done then it is allowable if the data has not been highpassed with a frequency higher than 1 Hz and lowpassed with a frequency lower than 50 Hz.
