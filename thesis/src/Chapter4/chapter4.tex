...
Further events of the case study as depicted on \autoref{fig:implementation-timeline-key-events} are described in \autoref{appendix4-case-study-other-key-events}.
