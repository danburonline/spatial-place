...
This section goes over each key event as shown in \autoref{fig:implementation-timeline-key-events} and discusses why it happened and why it was key to the project's success. The following outline of the key events are not chronologically described, but rather starts with the most influential ones, which were previously coloured green.
