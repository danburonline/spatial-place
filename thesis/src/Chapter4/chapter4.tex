...
Another early technical decision that was made via the help of expert interviews was the decision of the streaming technology to use. There are, as with many things in software, hundreds if not even thousands of ways to solve a problem such as streaming text-based data such as the EEG data from IDUN's device through the internet to the cloud.
