...
Further key events of the case study as displayed in black text depicted in \autoref{fig:implementation-timeline-key-events} are described in more detail in \autoref{appendix4-further-implementation-key-events}.
