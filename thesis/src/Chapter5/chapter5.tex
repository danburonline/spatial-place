...
This thesis first introduced the topics and some of the essential terms and their backgrounds in \autoref{chapter1-background}, drawing conclusions from the current state of research that have framed the aims and objectives of this thesis.
