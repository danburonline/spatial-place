...
\begin{enumerate}
  ...
  \item Develop and deploy the most relevant software components in a given and appropriate context to build a real-life N/CI.
  \item Publicly release an example N/CI application that demonstrates the applicability for HCI of a N/CI with web-based VR/AR applications.
\end{enumerate}
